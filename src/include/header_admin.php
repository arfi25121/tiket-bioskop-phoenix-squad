			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name"><?= $_SESSION['nama'] ?? 'Tanpa Nama'; ?></span>
					</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="./films" class="dropdown-toggle no-arrow">
							<span class="micon fa fa-film"></span><span class="mtext">Films</span>
						</a>
					</li>
					<li class="dropdown">
						<a href="./jadwal_film" class="dropdown-toggle no-arrow">
							<span class="micon fa fa-calendar"></span><span class="mtext">Jadwal Film</span>
						</a>
					</li>
					<li>
